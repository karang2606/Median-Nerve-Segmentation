...
def get_args_parser():
    ...
    parser.add_argument('--labels_loss', action='store_false',
                        help="Enables labels losses")
    parser.add_argument('--boxes_loss', action='store_false',
                        help="Enables bounding box losses")
    parser.add_argument('--L1_loss', action='store_false',
                        help="Enables L1 losses for bboxes")
    parser.add_argument('--giou_loss', action='store_false',
                        help="Enables Generalized IOU losses for bboxes")
    parser.add_argument('--focal_loss', action='store_false',
                        help="Enables Focal losses for mask")
    parser.add_argument('--dice_loss', action='store_false',
